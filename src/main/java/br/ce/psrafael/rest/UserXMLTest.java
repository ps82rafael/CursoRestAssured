...
public class UserXMLTest {
	...
	public static void setup() {
		...
		RequestSpecBuilder reqBulder = new RequestSpecBuilder();
		reqBulder.log(LogDetail.ALL);
		reqSpec = reqBulder.build();
	...
	@Test
	public void devoFazerPesquisaAvancadasComXMLComJava() {
	...
	@Test
	public void devoFazerPesquisaAvancadasComXMLComXpath() {
		given()
		.when()
			.get("/usersXML")
		.then()	
